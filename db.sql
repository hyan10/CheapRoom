...
alter table chart drop constraint FK_CHART_HOTEL_NO_HOTEL_NO;
alter table chart drop constraint FK_CHART_OWNER_NO_OWNER_NO;
alter table chart add constraint FK_CHART_OWNER_NO_OWNER_NO foreign key(owner_no) references owner(no) on delete set null; 
alter table chart add constraint FK_CHART_HOTEL_NO_HOTEL_NO foreign key(hotel_no) references hotel(no) on delete cascade; 
