...
public class BookingController {
	...
	public ModelAndView book(@RequestParam("roomNo") int roomNo, @ModelAttribute("search")SearchVO search){
	...
	//	List<RoomVO> roomList = hotel.getRooms();
		...
		// 날짜 계산
		String start = search.getStartDate();
		String end = search.getEndDate();
		////////////////////////////////////////////// 테스트 날짜 데이터
...
//		String end = "2017-06-02";
		...
		// 인원 수 추가 계산
		int totalPerson = search.getPersonNo(); // 4;
...
//										hotel.getName(), room.getName());
		...
		booking.setHotelNo(hotel.getNo());
		booking.setRoomNo(room.getNo());
		booking.setStartDate(start);
		booking.setEndDate(end);
		booking.setTotalPerson(totalPerson);
