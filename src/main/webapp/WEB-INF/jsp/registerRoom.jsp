...
function addForm(){
    ...
    str+="<hr style='border: solid 1px;'><div class='form-group'>"
		...
		+ "<label class='checkbox-inline'><input type='checkbox' name='roomList[" + count +"].cooking' value='cooking'>취사</label>"
		+ "<label class='checkbox-inline'><input type='checkbox' name='roomList[" + count +"].tv' value='tv'>TV</label>"
		+ "<label class='checkbox-inline'><input type='checkbox' name='roomList[" + count +"].ac' value='ac'>에어컨</label>"
		+ "</div>"
		+ "</div>"
		+ "</div>"
		+ "<div class='form-group'>"
...
<body>
	...
	<div class="container" style="margin: 10px;">
		...
		<hr style="border: solid 1px;"><div id="addedFormDiv">
			<div class="form-group">
				<div class="row">
					<label for="roomName" class="col-md-2"> 객실 이름 </label>
					<div class="col-md-5">
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="checkbox col-md-6">
						<label class="checkbox-inline"><input type="checkbox" name="roomList[0].cooking" value="cooking">취사</label>
						<label class="checkbox-inline"><input type="checkbox" name="roomList[0].tv" value="tv">TV</label>
						<label class="checkbox-inline"><input type="checkbox" name="roomList[0].ac" value="ac">에어컨</label>
					</div>
				</div>
			</div>
			<div class="form-group">
