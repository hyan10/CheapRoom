			...
			<div class="container">
				...
				<div class="project_description">
					<div class="widget_title dividerHeading">
						<h4><span><b>${chartList[0].year}년 ${chartList[0].month}월 호텔 별 통계 리스트</b></span></h4>
					</div>
						...
						<div class="col-lg-8 col-md-8 col-sm-8">
							...
							<div class="porDetCarousel">
								<div class="carousel-content">
									<img class="carousel-item" src="${pageContext.request.contextPath}/img/portfolio/portfolio_slider1.png" alt="">					
									<img class="carousel-item" src="${pageContext.request.contextPath}/img/portfolio/portfolio_slider2.png" alt="">
									<img class="carousel-item" src="${pageContext.request.contextPath}/img/portfolio/portfolio_slider3.png" alt="">
								</div>
							</div>
						</div> <!-- 이미지 끝 -->
